...
namespace Code_Generator
{
    public partial class frmMainForm : Form
    {
        ...
        private async void btnConnectSQLserver_Click(object sender, EventArgs e)
        {
            ...
            await Task.Run(() => _dt = clsConnectionManager.GetDBNames());
        ...
        private void btnSelectDB_Click(object sender, EventArgs e)
        {
            ...
            if(txtPath.Text == "")
            {
                MessageBox.Show("Select a Valid Path", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
